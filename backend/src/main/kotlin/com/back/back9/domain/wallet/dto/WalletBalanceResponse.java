...
public record  WalletBalanceResponse (
    ...
    public WalletBalanceResponse(long walletId, long userId, String address, BigDecimal balance) {
    ...
    // 정적 팩토리 메서드
    public WalletBalanceResponse of(long walletId, long userId, String address, BigDecimal balance) {
